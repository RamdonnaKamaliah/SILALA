        ...
        <div class="bg-white shadow rounded-xl p-6 border border-gray-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-purple-600 mt-2"><?php echo e($totalUsers); ?></p>
        ...
        <div class="bg-white shadow rounded-xl p-6 border border-gray-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-blue-600 mt-2"><?php echo e($karyawanCount); ?></p>
        ...
        <div class="bg-white shadow rounded-xl p-6 border border-gray-100 hover:shadow-md transition">
            <div class="flex items-center justify-between">
                <div>
                    ...
                    <p class="text-3xl font-bold text-green-600 mt-2"><?php echo e($magangCount); ?></p>
                    <p class="text-sm text-gray-500 mt-1">
            ...
            <div class="space-y-4">
                <div>
                    <div class="flex justify-between mb-1">
                        ...
                        <span class="text-sm font-medium text-gray-700"><?php echo e($karyawanCount); ?> (<?php echo e($totalUsers > 0 ? number_format(($karyawanCount/$totalUsers)*100, 1) : 0); ?>%)</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div class="bg-blue-600 h-3 rounded-full" 
                             style="width: <?php echo e($totalUsers > 0 ? ($karyawanCount/$totalUsers)*100 : 0); ?>%"></div>
                    </div>
                </div>
                <div>
                    <div class="flex justify-between mb-1">
                        <span class="text-sm font-medium text-gray-700">Magang/PKL</span>
                        <span class="text-sm font-medium text-gray-700"><?php echo e($magangCount); ?> (<?php echo e($totalUsers > 0 ? number_format(($magangCount/$totalUsers)*100, 1) : 0); ?>%)</span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-3">
                        <div class="bg-green-600 h-3 rounded-full" 
                             style="width: <?php echo e($totalUsers > 0 ? ($magangCount/$totalUsers)*100 : 0); ?>%"></div>
                    </div>
                </div>
            </div>
