...
<div class="max-w-4xl mx-auto px-4">
      ...
      <div class="flex items-center justify-between mb-2 md:px-0">
        ...
        <div class="flex items-center">
          <button id="loveBtn"
            ...
            <?php if($isFavorited): ?>
              <i id="heartIcon" class="fa-solid fa-heart text-red-500 text-base transition-transform duration-300 group-hover:scale-125"></i>
            <?php else: ?>
    ...
    <div class="bg-white w-full max-w-md rounded-2xl shadow-xl overflow-hidden relative">
      ...
      <div class="p-6 space-y-4 text-sm text-gray-800 max-h-[80vh] overflow-y-auto">
        ...
        <div class="flex justify-end gap-3 pt-4 sticky bottom-0 bg-white">
          <button id="closeModalBtn" class="bg-red-600 text-white font-semibold text-sm px-5 py-1.5 rounded-full shadow-md hover:opacity-90 transition">
            Batal
          </button>
  ...
  <!-- ====== MODAL PDF ====== -->
  <div id="pdfModal" class=" fixed inset-0 bg-black/50 backdrop-blur-md z-[99999] flex items-center justify-center p-4 <?php echo e($showPdfModal ?? false ? '' : 'hidden'); ?> ">
