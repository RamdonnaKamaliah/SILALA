...
<section class="relative bg-gradient-to-r from-[#626F47] to-[#A4B465] text-white px-3 py-3 md:px-10 md:py-2 rounded-2xl shadow-md flex items-center justify-between overflow-hidden"> 
  ...
  <!-- Bintang kiri atas -->
  <img src="<?php echo e(asset('assets/logo_bintang.png')); ?>" alt="star" class="absolute top-2 left-6 w-6 md:w-8 opacity-90 z-20">  

  <!-- Bintang kanan atas -->
  <img src="<?php echo e(asset('assets/logo_bintang.png')); ?>" alt="star" class="absolute top-2 right-6 w-6 md:w-8 opacity-90 z-20"> 
...
<div class="z-10">
  ...
  <p class="text-base md:text-lg mt-1 text-[#F7EDD6]/90">
    ...
    <img src="<?php echo e(asset('assets/emoji_bumi.png')); ?>" alt="Globe" class="inline w-5 h-5 md:w-6 md:h-6">
  </p> 
</div>
...
<?php /**PATH C:\laragon\www\silala_bpmsph\resources\views/user/dashboard.blade.php ENDPATH**/ ?>