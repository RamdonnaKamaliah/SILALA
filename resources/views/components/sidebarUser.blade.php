...
<div id="sidebar"
  ...
  <ul id="sidebar-menu" class="space-y-3">
    <li class="relative nav-item {{ request()->routeIs('user.profil') ? 'active' : '' }} rounded-l-[50px] hover:bg-white list-none">
      <a href="{{ route('user.profil') }}" class="group relative flex items-center w-full text-greentransition-all duration-300">
        <div
    ...
    <li class="relative nav-item {{ request()->routeIs('dashboard') ? 'active' : '' }} rounded-l-[30px] hover:bg-white list-none">
      <a href="{{ route('dashboard') }}" class="group relative flex items-center w-full text-greentransition-colors duration-300">
        <div
          class="menu-item flex items-center gap-3 border-[2px] border-cream bg-cream rounded-full px-4 py-3 ml-2 w-[230px] justify-start transition-all duration-300
          group-hover:border-transparent group-hover:bg-white">
    ...
    <li class="relative nav-item {{ request()->routeIs('user.riwayatbuku') ? 'active' : '' }} rounded-l-[30px] hover:bg-white list-none">
      <a href="{{ route('user.riwayatbuku')}}" class="group relative flex items-center w-full text-greentransition-colors duration-300">
        <div
          class="menu-item flex items-center gap-3 border-[2px] border-cream bg-cream rounded-full px-4 py-3 ml-2 w-[230px] justify-start transition-all duration-300
          group-hover:border-transparent group-hover:bg-white">
    ...
    <li class="relative nav-item {{ request()->routeIs('user.favorit') ? 'active' : '' }} rounded-l-[30px] hover:bg-white list-none">
      <a href="{{ route('user.favorit')}}" class="group relative flex items-center w-full text-greentransition-colors duration-300">
        <div
          class="menu-item flex items-center gap-3 border-[2px] border-cream bg-cream rounded-full px-4 py-3 ml-2 w-[230px] justify-start transition-all duration-300
          group-hover:border-transparent group-hover:bg-white">
