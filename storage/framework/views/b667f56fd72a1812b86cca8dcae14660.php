    ...
    <div class="min-h-screen bg-gradient-to-br from-[#f5f5e9] to-[#e8e4d5] p-4 md:p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800"><?php echo e($totalUser); ?></div>
                        <div class="flex items-center mt-2">
                            <span class="text-xs text-green-600 flex items-center">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800"><?php echo e($totalPeminjam); ?></div>
                        <div class="flex items-center mt-2">
                            <span class="text-xs text-green-600 flex items-center">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800"><?php echo e($totalArsip); ?></div>
                        <div class="flex items-center mt-2">
                            <span class="text-xs text-green-600 flex items-center">
