...
<div class="p-4 md:p-6 overflow-x-auto">
    ...
    <!-- Action Buttons -->
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            ...
            <form action="<?php echo e(route('admin.akun_admin.store')); ?>" method="POST">
                <?php echo csrf_field(); ?>
                <button
    type="submit"
                        ...
                        <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <div class="w-10 h-10 rounded-full bg-gradient-to-br from-[#A4B465] to-[#8A9A55] flex items-center justify-center flex-shrink-0">
                                    <span class="text-white font-semibold text-sm"><?php echo e(strtoupper(substr($admin->name, 0, 1))); ?></span>
                                </div>
                       ...
                       <td class="px-6 py-4">
                            <div class="flex items-center gap-3">
                                <span
                                    ...
                                    data-visible="false"
                                    data-password="<?php echo e($admin->plain_password); ?>"
                                >
                        ...
                        <td class="px-6 py-4 text-center">
                            <form
                                action="<?php echo e(route('admin.akun_admin.destroy', $admin)); ?>"
                                method="POST"
                                class="delete-form"
                            >
                                <?php echo csrf_field(); ?>
...
<?php echo $__env->make('layout_admin.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\silala_bpmsph\resources\views/admin/akun_admin/index.blade.php ENDPATH**/ ?>