...
@section('content')
    <div class="min-h-screen bg-[#F3EED9] py-10 px-6">
        <form method="POST" action="{{ route('user.updateprofil') }}" enctype="multipart/form-data">
            @csrf
            @method('PUT')
                ...
                <div class="flex flex-col md:flex-row gap-8 md:gap-10 items-start">
                    ...
                    <div class="flex flex-col w-full md:w-1/2 justify-between">
                        ...
                        <div class="flex justify-center mb-6">
                            <div class="relative">
                                <div
                                    class="w-36 h-36 rounded-full bg-[#F3F7EE] border-2 border-[#C9DABF] overflow-hidden 
                                ...
                                <label for="foto_profil"
                                    class="cursor-pointer absolute bottom-2 right-2 bg-[#8CA47E] hover:bg-[#7c946e] text-white p-2 rounded-full shadow-md transition"
                        ...
                        <div class="mt-2">
                            ...
                            <div class="mb-1">
                                <label for="current_password"
                                    class="flex items-center text-[#2E2E2E] text-sm font-medium mb-1">
                                    <span class="iconify mr-2 text-[#8CA47E]" data-icon="mdi:lock-outline"></span> Password
                                    Sekarang
                                </label>
                                <div class="relative">
                                    <input id="current_password" name="current_password" type="password"
                                        placeholder="Masukkan password saat ini" autocomplete="new-password"
                                        class="w-full border border-[#DADADA] rounded-md py-2 px-3 text-sm focus:outline-none focus:ring-1 focus:ring-[#8CA47E] pr-10" />

                                    <button type="button"
                                        class="absolute right-3 top-1/2 transform -translate-y-1/2 text-gray-500 hover:text-[#8CA47E] transition"
                                        onclick="togglePassword('current_password', 'current_password_eye')">
                                        <span id="current_password_eye" class="iconify" data-icon="mdi:eye-off-outline"
                                            data-width="20"></span>
                                    </button>
                                </div>
                            ...
                            <div class="mt-4">
                                <label for="new_password" class="flex items-center text-[#2E2E2E] text-sm font-medium mb-1">
                                    <span class="iconify mr-2 text-[#8CA47E]" data-icon="mdi:lock-reset"></span> Password
                                    Baru
                                </label>
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        ...
                                        <span id="new_password_eye" class="iconify" data-icon="mdi:eye-off-outline"
                                            data-width="20"></span>
                                    </button>
                                </div>
                                @error('new_password')
                            ...
                            <div class="mt-4">
                                <label for="new_password_confirmation"
                                    class="flex items-center text-[#2E2E2E] text-sm font-medium mb-1">
                                    <span class="iconify mr-2 text-[#8CA47E]" data-icon="mdi:lock-check-outline"></span>
                                    Konfirmasi Password Baru
                                </label>
                                <div class="relative">
                                    ...
                                    <button type="button"
                                        ...
                                        <span id="new_password_confirmation_eye" class="iconify"
                                            data-icon="mdi:eye-off-outline" data-width="20"></span>
                                    </button>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col w-full md:w-1/2 gap-4">
                        ...
                        <div>
                            <label for="name" class="flex items-center text-[#2E2E2E] text-sm font-medium mb-1">
                                <span class="iconify mr-2 text-[#8CA47E]" data-icon="mdi:account-outline"></span> Nama
                                Lengkap
                            </label>
                        ...
                        <div>
                            <label class="flex items-center text-[#2E2E2E] text-sm font-medium mb-1">
                                <span class="iconify mr-2 text-[#8CA47E]" data-icon="mdi:gender-female"></span> Jenis
                                Kelamin
                            </label>
                            <div class="flex items-center space-x-6">
                                <label class="flex items-center text-sm text-[#2E2E2E]">
                                    <input type="radio" name="gender" value="Perempuan"
                                        {{ old('gender', Auth::user()->gender) == 'P' || old('gender') == 'Perempuan' ? 'checked' : '' }}
                                        class="accent-[#8CA47E] mr-2" /> Perempuan
                                </label>
                                <label class="flex items-center text-sm text-[#2E2E2E]">
                                    <input type="radio" name="gender" value="Laki-laki"
                                        {{ old('gender', Auth::user()->gender) == 'L' || old('gender') == 'Laki-laki' ? 'checked' : '' }}
                                        class="accent-[#8CA47E] mr-2" /> Laki-laki
                                </label>
                            </div>
                            @error('gender')
                                <p class="text-red-500 text-xs mt-1">{{ $message }}</p>
                        ...
                        <div>
                            <label class="flex items-center text-[#2E2E2E] text-sm font-medium mb-1">
                                <span class="iconify mr-2 text-[#8CA47E]" data-icon="mdi:card-account-details"></span>
                                Tipe Keanggotaan
                            </label>
                            ...
                            <div class="bg-[#F8F8F8] border border-[#DADADA] rounded-md p-4">
                                <div class="flex flex-col sm:flex-row sm:items-center space-y-2 sm:space-y-0 sm:space-x-6">
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="karyawan"
                                            class="text-sm text-[#2E2E2E] cursor-pointer flex items-center">
                                            <span class="iconify mr-1" data-icon="mdi:briefcase-account"
                                                data-width="16"></span>
                                            Karyawan
                                        </label>
                                    </div>
                                    ...
                                    <div class="flex items-center">
                                        ...
                                        <label for="magang"
                                            class="text-sm text-[#2E2E2E] cursor-pointer flex items-center">
                                            <span class="iconify mr-1" data-icon="mdi:school-outline"
                                                data-width="16"></span>
                                            Magang
                                        </label>
                                    </div>
