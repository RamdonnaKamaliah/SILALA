...
<?php $__env->startSection('content'); ?>
    <div class="max-w-4xl mx-auto px-4">
                ...
                <div class="flex items-center justify-between mb-2 md:px-0">
                    ...
                    <div class="flex items-center gap-3 md:ml-[350px]">
                        ...
                        <?php if($buku->file_buku && $buku->id): ?>
                            <button id="button" type="button" data-url="<?php echo e(route('user.baca', $buku->id)); ?>" 
        ...
        <!-- ====== MODAL PDF ====== -->
        <div id="pdfModal"
            class=" fixed inset-0 bg-black/50 backdrop-blur-md z-[99999] flex items-center justify-center p-4 <?php echo e($showPdfModal ?? false ? '' : 'hidden'); ?> ">
            <div
