 ...
 <div class="min-h-screen p-4 md:p-6">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $peminjamAktif }}</div>
                    </div>
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $bukuDipinjam }}</div>                       
                    </div>                   
                </div>
            </div>
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $bukuArsip }}</div>                      
                    </div>              
                </div>
            </div>
        </div>
            ...
            <div class="space-y-3">
                @forelse ($activities as $activity)
                    <div class="flex items-center p-3 hover:bg-gray-50 rounded-lg transition-colors duration-200">
                        <div class="w-10 h-10 rounded-full {{ $activity['bg'] }} flex items-center justify-center mr-3">
                        ...
                        <div class="flex-1">
                            ...
                            <p class="text-xs text-gray-500">
                                {{ $activity['desc'] }} • {{ $activity['time']->diffForHumans() }}
                            </p>
                        </div>

                        @if ($activity['type'] === 'pengingat')
