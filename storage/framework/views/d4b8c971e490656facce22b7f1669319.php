    ...
    <div class="container mx-auto">
        ...
        <div class="glass-effect rounded-2xl shadow-[0_8px_32px_rgba(0,0,0,0.1)] mb-3.5 p-5 relative overflow-hidden flex justify-between items-center">
            <div class="flex items-start gap-6">
                <img src="<?php echo e(asset('/assets_admin/image/sisapa.png')); ?>" alt="Logo Silala" class="w-24 h-24 rounded-xl object-contain opacity-90 transition-all duration-300 hover:opacity-100 hover:scale-105 filter drop-shadow-[0_4px_8px_rgba(0,0,0,0.2)] hover:drop-shadow-[0_6px_12px_rgba(0,0,0,0.3)]">
                <div class="mt-3.5">
