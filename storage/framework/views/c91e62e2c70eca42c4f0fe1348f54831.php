...
<aside id="sidebar" class="sidebar fixed top-0 left-0 h-full w-64 dark:bg-[#2A320F] bg-[#F5ECD5] dark:text-white text-gray-900 shadow-xl z-50 md:hidden transform -translate-x-full transition-transform duration-300">
  ...
  <nav class="p-4">
    <ul class="space-y-2">
      <li><a href="/" class="flex items-center px-4 py-3 hover:bg-green-700 rounded-lg font-semibold transition-all duration-200"><i class="fas fa-home mr-3"></i>Beranda</a></li>
      <li><a href="#tentang" class="flex items-center px-4 py-3 hover:bg-green-700 rounded-lg font-medium transition-all duration-200"><i class="fas fa-info-circle mr-3"></i>Tentang</a></li>
      <li><a href="#rekomendasi" class="flex items-center px-4 py-3 hover:bg-green-700 rounded-lg font-medium transition-all duration-200"><i class="fas fa-book mr-3"></i>Rekomendasi</a></li>
      <li><a href="#panduan" class="flex items-center px-4 py-3 hover:bg-green-700 rounded-lg font-medium transition-all duration-200"><i class="fas fa-question-circle mr-3"></i>Panduan</a></li>
    </ul>
...
<?php /**PATH C:\laragon\www\silala_bpmsph\resources\views\components\navbarlanding.blade.php ENDPATH**/ ?>