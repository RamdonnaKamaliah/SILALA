...
<?php $__env->startSection('content'); ?>
    ...
    <!-- Kartu Sambutan -->
    <section
        class="relative bg-gradient-to-r from-green to-[#A4B465] text-white 
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="flex items-start bg-transparent p-3 hover:scale-[1.03] transition-transform duration-300">
                    <div class="relative w-32 h-44 flex-shrink-0">
                        <div class="absolute inset-0 bg-gradient-to-r from-[#00000020] to-transparent rounded-lg shadow-md">
                        </div>
                    ...
                    <div class="ml-4 flex flex-col justify-between h-full">
                        ...
                        <button
                            class="bg-[#626F47] text-white text-xs px-5 py-1.5 rounded-full hover:bg-[#4e5d38] transition w-fit">
                            Baca
                        </button>
                    </div>
                </div>
