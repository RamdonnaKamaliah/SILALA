        ...
        <div class="px-6 py-6 md:px-10 md:py-8 flex flex-col justify-center">
            ...
            <form method="POST" action="{{ route('login') }}" class="space-y-4">
                ...
                <div class="flex items-center justify-between">
                    <a href="{{ route('password.request') }}" class="text-xs text-green-700 hover:underline">Lupa
                        Password?</a>
                    <button type="submit"
                ...
                <div class="mt-4 text-center">
                    <p class="text-base text-gray-600 mb-2">
                        Belum punya akun?
                        <a href="{{ route('register') }}" class="font-medium text-green-700 hover:underline">Daftar di
                            sini</a>
                    </p>
