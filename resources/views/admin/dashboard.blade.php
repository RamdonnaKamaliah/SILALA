        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-6">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $totalBuku }}</div>
            ...
            <div
                ...
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h3 class="text-sm font-semibold text-gray-600">Total Pengguna</h3>
                    </div>
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $totalUser }}</div>
                        <div class="flex items-center mt-2">
                            <span class="text-xs text-green-600 flex items-center">
            ...
            <div
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $totalPeminjam }}</div>
                        <div class="flex items-center mt-2">
                            <span class="text-xs text-green-600 flex items-center">
            ...
            <div
                ...
                <div class="flex justify-between items-start mb-4">
                    <div>
                        <h3 class="text-sm font-semibold text-gray-600">Total Buku yang di Arsip</h3>
                    </div>
                ...
                <div class="flex items-end justify-between">
                    <div>
                        <div class="text-2xl font-bold text-gray-800">{{ $totalArsip }}</div>
                        <div class="flex items-center mt-2">
                            <span class="text-xs text-green-600 flex items-center">
        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-6">
            ...
            <div class="bg-white rounded-xl p-4 shadow-sm">
                <div class="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-4">
                    <div>
                        <h3 class="text-lg font-semibold text-gray-800">Statistik Peminjaman & Pengembalian</h3>
                        <select name="" id="filterStatistik"
                            class="mt-2 border border-gray-400 rounded-lg px-4 py-2">
