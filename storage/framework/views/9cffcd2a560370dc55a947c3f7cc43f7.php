...
<div id="sidebar"
  ...
  <ul id="sidebar-menu" class="space-y-3">
    <li class="relative nav-item <?php echo e(request()->routeIs('user.profil') ? 'active' : ''); ?> rounded-l-[50px] hover:bg-white list-none">
      <a href="<?php echo e(route('user.profil')); ?>" class="group relative flex items-center w-full text-[#626F47] transition-all duration-300">
        <div
          ...
          <div class="leading-tight flex-1 min-w-0">
            <p class="font-bold text-[#626F47] text-sm truncate"><?php echo e(Auth::user()->name); ?></p>
    ...
    <li class="relative nav-item <?php echo e(request()->routeIs('user.daftarbuku') ? 'active' : ''); ?> rounded-l-[30px] hover:bg-white list-none">
    ...
    <li class="relative nav-item rounded-l-[30px] hover:bg-white list-none">
      <form action="<?php echo e(route('logout')); ?>" method="POST"> 
        <?php echo csrf_field(); ?> 
        <button type="submit" class="group relative flex items-center w-full text-red-600 transition-colors duration-300"> 
