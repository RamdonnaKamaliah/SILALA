$(document).ready(function () {
    ...
    function updateBulkButtons() {
        ...
        if (checked > 0) {
            deleteBtn.removeClass('opacity-50 bg-gray-400 cursor-not-allowed')
                     .addClass('bg-red-600 hover:bg-red-700')
                     .prop('disabled', false);
            archiveBtn.removeClass('opacity-50 bg-gray-400 cursor-not-allowed')
                       .addClass('bg-yellow-600 hover:bg-yellow-700')
                       .prop('disabled', false);
            
            const ids = $('.row-checkbox:checked').not('#selectAll').map(function() {
                return $(this).val();
            }).get();
            ...
            deleteBtn.addClass('opacity-50 bg-gray-400 cursor-not-allowed')
                     .removeClass('bg-red-600 hover:bg-red-700')
                     .prop('disabled', true);
            archiveBtn.addClass('opacity-50 bg-gray-400 cursor-not-allowed')
