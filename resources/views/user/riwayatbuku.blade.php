...
<div class="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
  ...
  <a href="{{ route('user.riwayatbuku') }}" class="flex items-center gap-2 px-4 py-2 text-sm font-semibold bg-white text-green-600 hover:bg-gray-100 cursor-pointer">
        ...
        <td class="py-4 px-4 text-gray-800 font-medium whitespace-nowrap relative">
          ...
          <div class="flex flex-col gap-2">
            ...
            <div class="flex items-center gap-2 text-sm">
              ...
              <button data-id="{{ $data->id }}" data-judul="{{ $data->buku->judul_buku }}" onclick="bukaModalFotoUlang(this)"
...
>
  ...
  id="btnKirimFoto"
  onclick="kirimFoto()"
  class="flex-1 bg-green text-white font-semibold text-sm px-5 py-2 rounded-full shadow-md hover:opacity-90 transition items-center justify-center gap-1 {{ $showBtnKirim ?? false ? 'flex' : 'hidden' }}"
>
