...
<body class="min-h-screen flex flex-col font-[Ubuntu,sans-serif] bg-white">
  ...
  {{-- KONTEN UTAMA --}}
  <main class="pt-8 pb-6 px-4 md:px-6 bg-cream relative top-[90px] mb-24 md:ml-[320px] md:mr-3 md:rounded-3xl transition-all duration-300 z-20 flex flex-col max-w-full shadow-inner">
    @yield('content')
</main>
