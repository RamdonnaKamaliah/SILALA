            ...
            <div class="relative rounded-2xl overflow-hidden shadow-2xl">
                ...
                <div class="relative z-10 px-6 pt-5 pb-2 md:px-8 md:pt-7 md:pb-2 flex flex-row items-center justify-between">
                    ...
                    <div class="w-2/3 pr-4">
                        <div
                            class="inline-flex items-center px-3 py-1 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 mb-3">
                    ...
                    <div class="w-1/3 flex items-center justify-center">
                        <img src="<?php echo e(asset('/assets_admin/image/sapa.png')); ?>" alt="Sapaan Admin"
                            class="max-w-full h-auto floating pulse-glow" style="max-height: 180px;">
                    </div>
                </div>
            </div>
        </div>
