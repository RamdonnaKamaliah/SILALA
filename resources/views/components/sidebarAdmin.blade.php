 <li class="mt-0.5 w-full">
             ...
             <li class="mt-0.5 w-full">
    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
       href="{{ route('admin.arsip_buku.index') }}">
        ...
        <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Data Favorit</span>
    </a>
</li>
             ...
             <li class="mt-0.5 w-full">
                 <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors"
                     ...
                     <span class="ml-1 duration-300 opacity-100 pointer-events-none ease-soft">Total Denda</span>
                 </a>
             </li>
