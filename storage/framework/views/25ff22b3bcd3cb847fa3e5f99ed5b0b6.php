                        ...
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4 flex justify-center">
                            <?php if($buku->foto_buku): ?>
                                <div class="relative group">
                                    <img src="<?php echo e(asset($buku->foto_buku)); ?>" 
                                         alt="Foto Buku <?php echo e($buku->judul_buku); ?>"
                    ...
                    <div>
                        ...
                        <div class="bg-gradient-to-br from-green-50 to-emerald-50 rounded-2xl p-4">
                            <?php if($buku->file_buku): ?>
                                <a href="<?php echo e(asset($buku->file_buku)); ?>" 
                                   target="_blank"
                                ...
                                <div class="flex items-start bg-white p-4 rounded-xl shadow-sm border border-green-50 hover:shadow-md transition-shadow duration-300">
                                    ...
                                    <div class="flex-1 min-w-0">
                                        ...
                                        <p class="font-semibold text-gray-800">
                                            <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium <?php echo e($buku->stok > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800'); ?>">
