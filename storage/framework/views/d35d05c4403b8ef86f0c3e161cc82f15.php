...
<?php $__env->startSection('content'); ?>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                <?php $__currentLoopData = $logos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $setting): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div
                        class="border-2 border-gray-200 rounded-lg p-6 hover:border-green-400 hover:shadow-md transition-all duration-300">
                        ...
                        <form action="<?php echo e(route('admin.cms.upload')); ?>" method="POST" enctype="multipart/form-data"
                            class="upload-form" data-key="<?php echo e($setting->key); ?>">
                            <?php echo csrf_field(); ?>
                            ...
                            <?php if($setting->value && Storage::disk('public')->exists('cms/' . $setting->value)): ?>
                                ...
                                <div class="mb-4">
                                    <div class="relative group">
                                        <img src="<?php echo e(asset('storage/cms/' . $setting->value)); ?>" alt="<?php echo e($setting->label); ?>"
                            ...
                            <?php else: ?>
                                ...
                                <div class="mb-4">
                                    <div class="relative">
                                        <img src="<?php echo e(asset($setting->value)); ?>" alt="<?php echo e($setting->label); ?>"
                                            class="w-full h-48 object-contain bg-gray-50 rounded-lg border-2 border-gray-200">
                                    ...
                                    <p class="text-xs text-gray-500 mt-2 text-center">Gambar default - Pilih file untuk
                                        mengganti</p>
                                </div>
                            <?php endif; ?>
                            ...
                            <div class="space-y-3">
                                <input type="file" name="image"
                                    ...
                                    accept="image/png,image/jpg,image/jpeg,image/svg+xml,image/webp" required>
    ...
    <div id="loading-overlay" class="hidden fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
        <div class="bg-white rounded-xl shadow-2xl p-8 flex flex-col items-center">
            <svg class="animate-spin h-12 w-12 text-green-600 mb-4" xmlns="http://www.w3.org/2000/svg" fill="none"
                viewBox="0 0 24 24">
