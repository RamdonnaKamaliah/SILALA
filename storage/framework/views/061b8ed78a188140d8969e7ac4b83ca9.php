    ...
    <body class="bg-gray-50">
        ...
        <!-- Sidebar -->
        <aside id="sidebar" class="fixed top-0 left-0 h-screen w-64 blur-backdrop shadow-lg z-50 overflow-y-auto sidebar-transition sidebar-desktop">
            <!-- Tombol Close (hanya muncul di mobile) -->
            <button id="sidebar-close" class="lg:hidden absolute top-4 right-4 p-2 rounded-lg bg-white shadow-md text-purple-700">
                <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <ul class="mt-16 lg:mt-4 space-y-1">
                ...
                <li class="mt-0.5 w-full">
                    <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap rounded-lg px-4 font-semibold transition-colors hover:bg-purple-50 hover:text-purple-dark text-slate-700"
                        ...
                        <div class="bg-gradient-to-tl from-purple-dark to-pink-dark shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
