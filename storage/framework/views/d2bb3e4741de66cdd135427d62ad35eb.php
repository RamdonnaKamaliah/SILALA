...
<head>
    ...
    <style>
        ...
        .custom-scrollbar::-webkit-scrollbar-thumb {
            background: linear-gradient(to bottom, #2d5a27, #3d6b34);
            border-radius: 3px;
        }
        
        .custom-scrollbar::-webkit-scrollbar-thumb:hover {
            background: linear-gradient(to bottom, #3d6b34, #4c7c41);
        }
        ...
        <div class="navbar-padding">
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center flex-1 min-w-0">
                    <button id="navbar-sidebar-toggle" class="lg:hidden p-2 rounded-lg text-army-pale hover:text-white hover:bg-army-light/30 focus:outline-none transition-all duration-200">
                    ...
                    <div class="hidden lg:block relative flex-1 max-w-md ml-4">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <i class="fas fa-search text-army-pale/80"></i>
                        </div>
                        <input type="text" class="block w-full pl-10 pr-3 py-2.5 border border-army-light/30 rounded-xl leading-5 bg-white/10 backdrop-blur-sm placeholder-army-pale/80 focus:outline-none focus:ring-2 focus:ring-white/50 focus:border-white/30 text-white text-sm transition-all duration-200" placeholder="Cari buku, anggota, atau transaksi...">
                    </div>
                </div>
                ...
                <div class="flex items-center navbar-icon-spacing space-x-1 sm:space-x-2 flex-shrink-0 ml-2">
                    <!-- Search Mobile -->
                    <button class="lg:hidden p-2 rounded-full text-army-pale hover:text-white hover:bg-army-light/30 focus:outline-none transition-all duration-200" id="mobile-search-button">
                        <i class="fas fa-search text-base sm:text-lg"></i>
                    </button>

                    <!-- Notifikasi -->
                    <div class="relative dropdown-container">
                        <button class="p-2 rounded-full text-army-pale hover:text-white hover:bg-army-light/30 focus:outline-none focus:ring-2 focus:ring-white/50 relative transition-all duration-200" id="notification-button">
                            <i class="fas fa-bell text-base sm:text-lg"></i>
                            <span class="notification-badge">3</span>
                        </button>
                        
                        <div class="dropdown-menu popup-shadow border border-army-pale/50 glass-effect" id="notification-popup">
                            <div class="p-4 border-b border-army-pale/30 bg-gradient-to-r from-army-pale to-white rounded-t-xl">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-base sm:text-lg font-bold text-army-text flex items-center">
                                        <i class="fas fa-bell mr-2 text-army-medium"></i>
                                        Notifikasi
                                    </h3>
                                    <span class="text-xs text-army-medium cursor-pointer hover:underline font-medium flex items-center">
                            ...
                            <div class="dropdown-content overflow-y-auto custom-scrollbar">
                                <div class="notification-item p-3 sm:p-4 border-b border-army-pale/30 hover:bg-army-pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 flex-1 min-w-0">
                                            <div class="flex justify-between items-start gap-2">
                                                ...
                                                <span class="text-xs text-army-medium bg-army-pale/50 px-2 py-1 rounded-full font-medium whitespace-nowrap">Baru</span>
                                            </div>
                                ...
                                <div class="notification-item p-3 sm:p-4 hover:bg-army-pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 mt-1">
                            ...
                            <div class="p-3 border-t border-army-pale/30 bg-white rounded-b-xl">
                                <a href="#" class="flex items-center justify-center text-sm font-semibold text-army-medium hover:text-army-dark transition-colors duration-200 py-2 rounded-lg hover:bg-army-pale/50">
                    ...
                    <!-- Pesan -->
                    <div class="relative dropdown-container">
                        <button class="p-2 rounded-full text-army-pale hover:text-white hover:bg-army-light/30 focus:outline-none focus:ring-2 focus:ring-white/50 relative transition-all duration-200" id="message-button">
                            <i class="fas fa-envelope text-base sm:text-lg"></i>
                            <span class="message-badge">5</span>
                        </button>
                        
                        <div class="dropdown-menu popup-shadow border border-army-pale/50 glass-effect" id="message-popup">
                            <div class="p-4 border-b border-army-pale/30 bg-gradient-to-r from-army-pale to-white rounded-t-xl">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-base sm:text-lg font-bold text-army-text flex items-center">
                                        <i class="fas fa-envelope mr-2 text-army-medium"></i>
                                        Pesan
                                    </h3>
                                    <span class="text-xs text-army-medium cursor-pointer hover:underline font-medium flex items-center">
                                        <i class="fas fa-check-double mr-1"></i>
                            ...
                            <div class="dropdown-content overflow-y-auto custom-scrollbar">
                                <div class="message-item p-3 sm:p-4 border-b border-army-pale/30 hover:bg-army-pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 mt-1">
                                ...
                                <div class="message-item p-3 sm:p-4 hover:bg-army-pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 mt-1">
                    ...
                    <!-- Profil Dropdown -->
                    <div class="relative dropdown-container">
                        <button class="flex items-center text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-white/50 hover:bg-army-light/30 px-2 sm:px-3 py-2 transition-all duration-200 group" id="user-menu-button">
                            ...
                            <div class="ml-2 sm:ml-3 text-left hidden lg:block">
                                ...
                                <p class="text-army-pale/80 text-xs">Administrator</p>
                            </div>
                            <i class="fas fa-chevron-down ml-2 text-army-pale/80 text-xs hidden lg:block transition-transform duration-200" id="chevron-icon"></i>
                        </button>
                        
                        <div class="dropdown-menu shadow-2xl border border-army-pale/30 glass-effect" id="dropdown-menu">
                            <div class="p-4 sm:p-6 bg-gradient-to-br from-army-dark to-army-medium rounded-t-2xl text-white">
                            ...
                            <div class="p-3 sm:p-4 space-y-2">
                                <a href="#" class="profile-item flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 text-sm text-gray-700 hover:bg-army-pale/50 hover:text-army-dark rounded-xl transition-all duration-200 group">
                                    <div class="flex items-center min-w-0 flex-1">
                                        <div class="w-8 h-8 flex items-center justify-center mr-3 bg-army-pale rounded-lg group-hover:bg-army-medium group-hover:text-white transition-all duration-200 flex-shrink-0">
                                            <i class="fas fa-question-circle text-army-medium group-hover:text-white text-sm"></i>
                                        </div>
                                        <div class="min-w-0">
                                    ...
                                    <i class="fas fa-chevron-right text-gray-400 group-hover:text-army-dark text-xs ml-2 flex-shrink-0"></i>
                                </a>
                            </div>
                            
                            <div class="border-t border-army-pale/30 mx-4"></div>
            ...
            <div class="hidden lg:hidden mobile-search-container" id="mobile-search">
                <div class="relative">
                    <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <i class="fas fa-search text-army-medium"></i>
                    </div>
                    <input type="text" class="block w-full pl-10 pr-3 py-2.5 border border-army-light/30 rounded-xl leading-5 bg-white placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-army-medium focus:border-army-light text-gray-800 text-sm transition-all duration-200" placeholder="Cari buku, anggota, atau transaksi...">
                </div>
            </div>
        </div>
    </nav>
