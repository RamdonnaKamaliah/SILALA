...
<?php $__env->startSection('content'); ?>
    ...
    <div class="min-h-screen p-4 md:p-6">
        ...
        <div class="max-w-5xl mx-auto">
            ...
            <div
                class="bg-gradient-to-br from-[#A4B465] via-[#8FA056] to-[#6E7C45] rounded-2xl shadow-xl p-8 mb-6 relative overflow-hidden">
                <!-- Decorative Elements -->
                ...
                <div class="p-6 md:p-8">
                    <div class="flex flex-col md:flex-row items-start md:items-center gap-8">
                        ...
                        <div class="relative mx-auto md:mx-0 group">
                            <!-- Glow Effect -->
                            <div
                                class="absolute inset-0 bg-gradient-to-br from-[#A4B465] to-[#6E7C45] rounded-2xl blur-xl opacity-30 group-hover:opacity-50 transition-opacity">
                            </div>

                            <div
                                class="relative w-36 h-36 md:w-44 md:h-44 rounded-2xl overflow-hidden shadow-xl border-4 border-white ring-4 ring-[#A4B465]/20">
                            ...
                            <!-- Badge -->
                            <div
                                class="absolute -bottom-3 -right-3 bg-gradient-to-br from-[#A4B465] to-[#6E7C45] text-white p-3 rounded-xl shadow-lg">
                        ...
                        <div class="flex-1 text-center md:text-left">
                            <div class="flex flex-col md:flex-row md:items-center gap-3 mb-4">
                                <h2
                                    class="text-3xl md:text-4xl font-bold bg-gradient-to-r from-[#6E7C45] to-[#A4B465] bg-clip-text text-transparent">
                                ...
                                <?php if($admin->role === 'administrator'): ?>
                                    <span
                                        class="inline-flex items-center gap-1.5 bg-gradient-to-r from-[#A4B465] to-[#8FA056] text-white text-xs font-semibold px-4 py-1.5 rounded-full shadow-md">
                            ...
                            <div class="space-y-3">
                                <div
                                    class="bg-gradient-to-r from-[#F9FBF4] to-[#F2F6E9] rounded-xl p-4 border border-[#DDE6C5]">
                                    <div class="flex items-center justify-center md:justify-start gap-3">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-[#A4B465] to-[#8FA056] rounded-lg flex items-center justify-center shadow-sm">
                                ...
                                <div
                                    ...
                                    <div class="flex items-center justify-center md:justify-start gap-3">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-[#6E7C45] to-[#5E6A3A] rounded-lg flex items-center justify-center shadow-sm">
                    ...
                    <div class="flex flex-col sm:flex-row gap-4 justify-center md:justify-end pt-6">
                        <a href="<?php echo e(route('superadmin.profile.edit')); ?>"
                            ...
                            <i
                                class="fas fa-arrow-right text-sm opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all duration-300 relative z-10"></i>
                        </a>
                    </div>
...
<?php echo $__env->make('layout_superAdmin.super_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/super_admin/profile/index.blade.php ENDPATH**/ ?>