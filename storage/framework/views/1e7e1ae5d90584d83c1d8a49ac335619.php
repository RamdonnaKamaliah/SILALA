...
<?php $__env->startSection('content'); ?>
    ...
    <div class="w-full">
        <div class="relative w-full mb-8">
            <input id="searchBuku" type="text" placeholder="Cari Buku..."
                class="w-full bg-primary border border-white rounded-full py-3 px-5 
    ...
    <div style="background-color:rgb(var(--primary));width:100px;height:100px"></div>
    ...
    <?php if($favorites->count() > 0): ?>
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
            <?php $__currentLoopData = $favorites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fav): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div
                    class="book-card bg-white rounded-xl shadow-md border border-[#E0D6B8] overflow-hidden p-3 flex gap-3 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                    ...
                    <div class="flex flex-col justify-between flex-grow">
                        <div>
                            <p class="book-title text-[#2E2E2E] text-sm font-semibold leading-tight">
                                <?php echo e($fav->buku->judul_buku); ?></p>
                        ...
                        <div class="flex items-center justify-between">
                            <a href="<?php echo e(route('user.baca', $fav->buku->id)); ?>"
                                class="bg-green hover:bg-primary text-white text-xs font-semibold px-6 py-[5px] rounded-full transition">Baca</a>
                            <button class="text-red-500 text-lg hover:scale-110 transition"
                                onclick="hapusFavorite(<?php echo e($fav->buku->id); ?>)">
