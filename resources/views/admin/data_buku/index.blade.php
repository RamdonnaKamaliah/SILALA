    ...
    <script>
        $(document).ready(function() {
            ...
            var table = $('#dataTable').DataTable({
                ...
                "pageLength": 5,
                "columnDefs": [
                    { "orderable": false, "targets": [0, 1, 9, 10] }, // Kolom checkbox, foto, file, aksi
                    { "searchable": false, "targets": [0, 1, 9] } // Kolom checkbox, foto, file
                ]
            });
            ...
            $('#bulkDeleteBtn').on('click', function(e) {
                ...
                if (selectedIds.length > 0) {
                    if (confirm('Apakah Anda yakin ingin menghapus ' + selectedIds.length + ' buku yang dipilih?')) {
