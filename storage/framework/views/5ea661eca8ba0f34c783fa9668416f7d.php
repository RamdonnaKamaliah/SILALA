                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            class="w-10 h-10 bg-gradient-to-br from-[#A4B465] to-[#8AA24F] rounded-lg flex items-center justify-center flex-shrink-0">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center justify-center gap-2">
                                        <a href="<?php echo e(route('superadmin.kategori.show', $kategori->id)); ?>"
                                            class="flex items-center gap-2 bg-blue-600 text-white px-3 py-2 rounded-lg hover:bg-blue-700 transition-all duration-200 shadow-sm transform hover:scale-105">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '.delete-btn', function(e) {
                ...
                var deleteUrl = "<?php echo e(route('admin.data_kategori.destroy', ':id')); ?>".replace(':id',
                    kategoriId);
