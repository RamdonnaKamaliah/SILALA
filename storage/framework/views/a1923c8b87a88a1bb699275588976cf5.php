        ...
        <div class="space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <div class="flex justify-center">
                    ...
                    <?php else: ?>
                        <div class="w-48 h-64 bg-gray-100 rounded-lg border-2 border-dashed border-gray-300 
                    ...
                    <?php if($buku->file_buku): ?>
                        <a href="<?php echo e(asset($buku->file_buku)); ?>" target="_blank"
                            class="flex items-center justify-center space-x-2 px-5 py-2.5
                                   ...
                                   shadow-md hover:shadow-lg text-sm w-full max-w-xs">
                            <i class="fas fa-download text-xs"></i>
                            <span>Download PDF</span>
                        </a>
                    <?php else: ?>
                        <div class="flex flex-col items-center justify-center space-y-1 text-gray-400 w-full max-w-xs">
