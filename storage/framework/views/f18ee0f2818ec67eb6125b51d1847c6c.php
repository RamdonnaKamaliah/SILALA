...
<div class="p-4 md:p-6 font-poppins">
                    ...
                    <?php if($buku->foto_buku): ?>
                        <div class="relative group">
                            <img src="<?php echo e(asset($buku->foto_buku)); ?>" alt="Cover <?php echo e($buku->judul_buku); ?>"
                                class="w-full max-w-xs h-80 object-cover rounded-xl shadow-lg border border-gray-200 
                                       group-hover:scale-105 transition-transform duration-300"
                                onerror="this.onerror=null; this.src='<?php echo e(asset('images/default-book.jpg')); ?>';">
                        </div>
                    <?php else: ?>
                        <div class="w-full max-w-xs h-80 bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl border-2 border-dashed border-gray-300 
                                  flex flex-col items-center justify-center text-gray-400 shadow-inner">
                            <i class="fas fa-book text-3xl mb-3"></i>
                            <p class="text-sm font-semibold">Tidak ada cover</p>
                        </div>
                    <?php endif; ?>
                </div>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    <?php if($buku->file_buku): ?>
                        ...
                        <!-- View PDF Button -->
                        <button type="button" onclick="openPdfModal('<?php echo e(asset($buku->file_buku)); ?>')"
                            class="flex items-center justify-center space-x-3 px-6 py-3
        ...
        <div class="xl:col-span-2 flex flex-col gap-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6 w-full">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <!-- Judul -->
                    <div class="md:col-span-2 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            <div class="w-8 h-8 bg-[#A4B465] rounded-lg flex items-center justify-center">
                                <i class="fas fa-heading text-white text-sm"></i>
                            </div>
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Judul Buku</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Penulis</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Penerbit</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Tahun Terbit</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Bahasa</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Edisi</label>
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Stok</label>
                                <span class="inline-flex items-center justify-center px-3 py-1 bg-gradient-to-r from-green-500 to-green-600 text-white rounded-full text-sm font-bold shadow-sm">
                    ...
                    <div class="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-1">Jumlah Halaman</label>
                    ...
                    <div class="md:col-span-2 bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-4 border border-gray-200">
                        <div class="flex items-start space-x-3">
                            ...
                            <div class="flex-1">
                                <label class="block text-xs font-bold text-gray-600 uppercase tracking-wide mb-2">Kategori</label>
                                <?php if($buku->kategoris->isNotEmpty()): ?>
                                    <div class="flex flex-wrap gap-2">
                                        <?php $__currentLoopData = $buku->kategoris; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kategori): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <span class="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-[#A4B465] to-[#8AA24F] text-white rounded-full text-xs font-bold shadow-sm">
    ...
    <div class="mt-6 pt-6 border-t border-gray-200">
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <form action="<?php echo e(route('admin.data_buku.restore', ['id' => $buku->id])); ?>" method="POST" class="flex-1 max-w-xs">
                <?php echo csrf_field(); ?>
            ...
            <form action="<?php echo e(route('admin.data_arsip.destroy', $buku->id)); ?>" method="POST" class="flex-1 max-w-xs">
                <?php echo csrf_field(); ?>
...
<div id="pdfModal" class="fixed inset-0 z-50 hidden">
    ...
    <div class="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-11/12 h-5/6 max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
        <!-- Modal Header -->
        <div class="flex items-center justify-between px-6 py-4 bg-gradient-to-r from-[#A4B465] to-[#8AA24F] text-white">
            <h3 class="text-lg font-bold">Preview PDF - <?php echo e($buku->judul_buku); ?></h3>
            <button onclick="closePdfModal()" class="w-8 h-8 flex items-center justify-center bg-white/20 rounded-lg hover:bg-white/30 transition-colors">
        ...
        <div class="h-full p-4 bg-gray-100">
            <iframe id="pdfViewer" class="w-full h-full rounded-lg border border-gray-300 bg-white" frameborder="0"></iframe>
        </div>
