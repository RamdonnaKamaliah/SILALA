            ...
            <nav class="flex" aria-label="Breadcrumb">
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    <li class="inline-flex items-center">
                        <a href="{{ route('admin.data_peminjam.index') }}" class="inline-flex items-center text-sm font-medium text-gray-700 hover:text-[#A4B465]">
            ...
            <div class="space-y-4">
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <p class="text-lg font-semibold {{ $peminjam->denda > 0 ? 'text-red-600' : 'text-green-600' }}">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">
                            {{ \Carbon\Carbon::parse($peminjam->tanggal_pinjam)->translatedFormat('d F Y') }}
                        </p>
                    </div>
                    ...
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">
                            {{ \Carbon\Carbon::parse($peminjam->tanggal_kembali)->translatedFormat('d F Y') }}
                        </p>
                    </div>
                </div>
                ...
                <div>
                    ...
                    <p class="text-gray-900 font-medium">
                        {{ \Carbon\Carbon::parse($peminjam->updated_at)->translatedFormat('d F Y H:i') }}
                    </p>
                </div>
                @endif
            </div>
        ...
        <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
                <div>
                    ...
                    <p class="text-gray-900 font-medium">{{ $peminjam->user->name ?? '-' }}</p>
                </div>
                
                <div>
                    <label class="block text-sm font-medium text-gray-600 mb-1">Email</label>
                    <p class="text-gray-900">{{ $peminjam->user->email ?? '-' }}</p>
                </div>
            </div>
        </div>
            ...
            <div class="flex flex-col md:flex-row gap-6">
                ...
                <div class="flex-1 grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                        ...
                        <p class="text-gray-900 font-medium">{{ $peminjam->buku->judul_buku ?? '-' }}</p>
                    </div>
                    ...
                    <div class="md:col-span-2">
                        ...
                        <p class="text-gray-900 text-sm leading-relaxed">
                            {{ $peminjam->buku->deskripsi ?? 'Tidak ada deskripsi' }}
                        </p>
                    </div>
                </div>
            </div>
