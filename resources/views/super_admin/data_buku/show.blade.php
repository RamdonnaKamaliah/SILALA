        ...
        <div class="max-w-4xl mx-auto">
            ...
            <div class="mb-8">
                <div class="flex flex-col md:flex-row md:items-center justify-between gap-4">
                    ...
                    <a href="{{ route('superadmin.data_buku.index') }}"
                                    ...
                                    <div
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <p class="font-semibold text-gray-800">
                                                <span
                                                    class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $buku->stok > 0 ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                                                    {{ $buku->stok }}
                                                </span>
                                            </p>
                                        </div>
