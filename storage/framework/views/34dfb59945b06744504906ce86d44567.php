...
<div id="sidebar"
    ...
    <ul id="sidebar-menu" class="space-y-3">
        <li
            class="relative nav-item <?php echo e(request()->routeIs('user.profil') ? 'active' : ''); ?> rounded-l-[50px] hover:bg-white list-none">
        ...
        <!-- Menu -->
        <li
            class="relative nav-item <?php echo e(request()->routeIs('dashboard') ? 'active' : ''); ?> rounded-l-[30px] hover:bg-white list-none">
        ...
        <li
            class="relative nav-item <?php echo e(request()->routeIs('user.daftarbuku', 'user.detailbuku') ? 'active' : ''); ?> rounded-l-[30px] hover:bg-white list-none">
        ...
        <li
            class="relative nav-item <?php echo e(request()->routeIs('user.riwayatbuku') ? 'active' : ''); ?> rounded-l-[30px] hover:bg-white list-none">
        ...
        <li
            class="relative nav-item <?php echo e(request()->routeIs('user.favorit') ? 'active' : ''); ?> rounded-l-[30px] hover:bg-white list-none">
