            ...
            <div class="user-stat-card rounded-xl p-4 md:p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-user-primary mb-1"><?php echo e($totalUsers); ?></p>
            ...
            <div class="user-stat-card rounded-xl p-4 md:p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-user-primary mb-1"><?php echo e($karyawanCount); ?></p>
                        <p class="text-xs text-gray-500">
            ...
            <div class="user-stat-card rounded-xl p-4 md:p-6 shadow-sm border border-gray-100">
                <div class="flex items-center justify-between">
                    <div class="flex-1">
                        ...
                        <p class="text-2xl md:text-3xl font-bold text-user-primary mb-1"><?php echo e($magangCount); ?></p>
                        <p class="text-xs text-gray-500">
                            <i class="fas fa-chart-pie mr-1"></i>
            ...
            <div class="space-y-5 md:space-y-6">
                ...
                <div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2">
                        ...
                        <span class="text-sm font-medium text-gray-700 bg-user-primary-50 px-2 py-1 rounded">
                            <?php echo e($karyawanCount); ?> (<?php echo e($totalUsers > 0 ? number_format(($karyawanCount/$totalUsers)*100, 1) : 0); ?>%)
                        </span>
                    </div>
                ...
                <div>
                    <div class="flex flex-col sm:flex-row sm:justify-between sm:items-center mb-2">
                        ...
                        <span class="text-sm font-medium text-gray-700 bg-user-primary-50 px-2 py-1 rounded">
                            <?php echo e($magangCount); ?> (<?php echo e($totalUsers > 0 ? number_format(($magangCount/$totalUsers)*100, 1) : 0); ?>%)
                        </span>
                    </div>
                    <div class="w-full bg-gray-200 rounded-full h-2.5 md:h-3">
                        <div class="user-progress-bar h-2.5 md:h-3 rounded-full transition-all duration-1000 ease-out" 
