            ...
            <form action="{{ route('admin.data_buku.update', $buku->id) }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="mb-8">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
                        <!-- Foto Buku -->
                        <div
                            class="bg-white border-2 border-dashed border-[#A4B465] rounded-xl p-6 text-center hover:border-[#8a9a58] hover:bg-[#f7faf7] transition-all duration-300 hover:-translate-y-1 @error('foto_buku')
                            ...
                            @if ($buku->foto_buku)
                                <div class="mt-4 text-center">
                                    <div class="bg-[#f7faf7] p-3 rounded-lg mb-3">
                                        ...
                                        <img src="{{ asset('storage/' . $buku->foto_buku) }}" alt="Foto Buku Saat Ini"
                        ...
                        <!-- File Buku PDF -->
                        <div
                            class="bg-white border-2 border-dashed border-[#A4B465] rounded-xl p-6 text-center hover:border-[#8a9a58] hover:bg-[#f7faf7] transition-all duration-300 hover:-translate-y-1 @error('file_buku')
                            border-dashed border-red-500
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
                        ...
                        <div>
                            ...
                            <input type="text" id="judul_buku" name="judul_buku"
                                value="{{ old('judul_buku', $buku->judul_buku) }}" placeholder="Masukkan judul buku"
                        ...
                        <div>
                            ...
                            <input type="number" id="tahun_terbit" name="tahun_terbit"
                                value="{{ old('tahun_terbit', $buku->tahun_terbit) }}" placeholder="Contoh: 2024"
                                class="w-full border-2 border-gray-300 bg-gray-50 rounded-lg px-4 py-3 text-gray-700 focus:border-[#A4B465] focus:ring-4 focus:ring-[#A4B465]/20 focus:bg-white outline-none transition-all duration-300"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="bahasa" name="bahasa"
                                value="{{ old('bahasa', $buku->bahasa) }}" placeholder="Contoh: Indonesia"
                                class="w-full border-2 border-gray-300 bg-gray-50 rounded-lg px-4 py-3 text-gray-700 focus:border-[#A4B465] focus:ring-4 focus:ring-[#A4B465]/20 focus:bg-white outline-none transition-all duration-300"
                                required>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-5">
                        ...
                        <div>
                            ...
                            <input type="number" id="jumlah_halaman" name="jumlah_halaman"
                                value="{{ old('jumlah_halaman', $buku->jumlah_halaman) }}" placeholder="0"
                                class="w-full border-2 border-gray-300 bg-gray-50 rounded-lg px-4 py-3 text-gray-700 focus:border-[#A4B465] focus:ring-4 focus:ring-[#A4B465]/20 focus:bg-white outline-none transition-all duration-300"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="text" id="edisi" name="edisi"
                                value="{{ old('edisi', $buku->edisi) }}" placeholder="Contoh: Edisi 1"
                                class="w-full border-2 border-gray-300 bg-gray-50 rounded-lg px-4 py-3 text-gray-700 focus:border-[#A4B465] focus:ring-4 focus:ring-[#A4B465]/20 focus:bg-white outline-none transition-all duration-300"
                                required>
                        </div>
                        ...
                        <div>
                            ...
                            <input type="number" id="stok" name="stok" value="{{ old('stok', $buku->stok) }}"
                                placeholder="0"
                                class="w-full border-2 border-gray-300 bg-gray-50 rounded-lg px-4 py-3 text-gray-700 focus:border-[#A4B465] focus:ring-4 focus:ring-[#A4B465]/20 focus:bg-white outline-none transition-all duration-300"
                                required>
                        </div>
