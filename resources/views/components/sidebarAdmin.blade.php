<aside class="fixed top-0 left-0 h-screen w-64 bg-white shadow-lg z-50 overflow-y-auto">
    <ul class="mt-4 space-y-1">
        ...
        <li class="mt-0.5 w-full">
            ...
            <a class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center whitespace-nowrap px-4 transition-colors hover:bg-red-50 hover:text-red-600 cursor-pointer"
