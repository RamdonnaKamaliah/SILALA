...
@section('pageTitle', 'Data Akun Admin')
...
@section('content')
    ...
    <div class="p-4 md:p-6 overflow-x-auto">
        ...
        <div class="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
            ...
            <form action="{{ route('superadmin.akun_admin.store') }}" method="POST">
                @csrf
                <button type="submit"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <div
                                            ...
                                            <span
                                                class="text-white font-semibold text-sm">{{ strtoupper(substr($admin->name, 0, 1)) }}</span>
                                        </div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="text-sm text-gray-900 flex items-center gap-2">
                                        ...
                                        <button type="button"
                                            ...
                                            data-email="{{ $admin->email }}" title="Copy email">
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        <span class="font-mono text-red-600 password-text blur-sm select-none transition"
                                            data-visible="false" data-password="{{ $admin->plain_password }}">
                                        ...
                                        <button type="button"
                                            ...
                                            data-password="{{ $admin->plain_password }}" title="Copy password">
                                            <i class="fas fa-copy"></i>
                                        </button>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-center">
                                    <form action="{{ route('superadmin.akun_admin.destroy', $admin) }}" method="POST"
                                        class="delete-form">
                                        @csrf
                                        @method('DELETE')
