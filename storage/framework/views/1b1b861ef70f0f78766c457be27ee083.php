    ...
    <a href="#" 
       class="flex items-center gap-3 rounded-xl hover:bg-primary_light/30 px-3 py-2 transition-all duration-200 group">
        ...
        <div class="hidden lg:block text-left">
            <p class="text-white font-semibold text-sm leading-tight"><?php echo e($admin->name); ?></p>
            <p class="text-primary_pale/80 text-xs"><?php echo e($admin->role ?? 'Administrator'); ?></p>
        </div>
...
</html><?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/components/navbarSuperAdmin.blade.php ENDPATH**/ ?>