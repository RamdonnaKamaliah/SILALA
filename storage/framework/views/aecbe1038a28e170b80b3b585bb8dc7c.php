...
<?php $__env->startSection('content'); ?>
    <div class="user-dashboard p-4 md:p-6 bg-gray-50 min-h-screen">
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 md:gap-6 mb-8">
            <!-- Total Pengguna -->
            <div
                class="bg-white rounded-xl p-4 md:p-6 shadow-md hover:shadow-xl border-l-4 border-[#A4B465] transition-all duration-300 hover:-translate-y-1">
        ...
        <div class="bg-white rounded-xl p-5 md:p-6 shadow-md mb-8 border border-gray-100">
            ...
            <div
                class="hidden md:block mt-6 p-4 bg-gradient-to-r from-[#F5F7ED] to-white rounded-lg border border-[#A4B465]/20">
