            ...
            <div class="mb-8">
                <div class="flex items-center gap-4 mb-2">
                    <a href="<?php echo e(route('admin.profile.index')); ?>"
                        class="w-10 h-10 bg-white rounded-lg shadow-md flex items-center justify-center hover:bg-[#F9FBF4] transition-all group">
                        <i class="fas fa-arrow-left text-[#6E7C45] group-hover:-translate-x-1 transition-transform"></i>
                    </a>
                    <div>
                        <h1
                            class="text-3xl font-bold bg-gradient-to-r from-[#6E7C45] to-[#A4B465] bg-clip-text text-transparent">
                            Edit Profile
                        </h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-[#DDE6C5] overflow-hidden h-full">
                        ...
                        <div class="p-6">
                            <form action="<?php echo e(route('superadmin.profile.update')); ?>" method="POST"
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div class="flex justify-center mb-4">
                                        <div class="relative">
                                            ...
                                            <div
                                                class="absolute bottom-0 right-0 w-7 h-7 bg-[#A4B465] rounded-full flex items-center justify-center shadow-lg">
                                    ...
                                    <div>
                                        ...
                                        <label class="block relative group cursor-pointer">
                                            <div
                                                class="border-2 border-dashed border-[#D8E2C0] rounded-xl p-4 bg-gradient-to-br from-[#F9FBF4] to-white hover:border-[#A4B465] transition-all">
                                                <div class="flex items-center gap-3">
                                                    <div
                                                        class="w-10 h-10 bg-gradient-to-br from-[#A4B465] to-[#8C9E55] rounded-full flex items-center justify-center group-hover:scale-110 transition-transform">
                                                        <i class="fas fa-cloud-upload-alt text-white"></i>
                                                    </div>
                                                    <div class="flex-1">
                                                        <p class="text-sm font-medium text-[#6E7C45]" id="btnFotoText">Pilih
                                                            Foto Baru</p>
                                        ...
                                        <span id="selectedFileName"
                                            class="hidden block text-xs text-green-600 font-medium mt-2"></span>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <span
                                                class="absolute right-3 top-1/2 -translate-y-1/2 text-xs bg-gray-200 text-gray-600 px-2 py-1 rounded-full font-medium">
                ...
                <div class="space-y-6">
                    ...
                    <div class="bg-white rounded-2xl shadow-xl border border-[#DDE6C5] overflow-hidden h-full">
                        ...
                        <div class="p-6">
                            <form id="formPassword" action="<?php echo e(route('superadmin.profile.updatePassword')); ?>"
                                method="POST">
                                <?php echo csrf_field(); ?>
                                ...
                                <div class="space-y-5">
                                    ...
                                    <div>
                                        ...
                                        <div class="relative">
                                            ...
                                            <button type="button"
                                                class="absolute right-3 top-1/2 -translate-y-1/2 text-gray-400 hover:text-[#6E7C45] transition-colors">
                                ...
                                <!-- Info Box -->
                                <div
                                    class="mt-5 bg-gradient-to-r from-[#FEF3C7] to-[#FDE68A] border-l-4 border-[#F59E0B] rounded-xl p-4">
    ...
    <script>
        ...
        function enableSaveButton() {
            ...
            if (btnSave) {
                ...
                btnSave.classList.add('bg-gradient-to-r', 'from-[#A4B465]', 'to-[#8C9E55]', 'hover:from-[#8C9E55]',
                    'hover:to-[#6E7C45]');
            }
        }
                    ...
                    input.addEventListener('input', function() {
                        ...
                        if (btnSavePassword) {
                            if (allFilled) {
                                ...
                                btnSavePassword.classList.remove('disabled:bg-gray-400',
                                    'bg-gray-400');
                                btnSavePassword.classList.add('bg-gradient-to-r', 'from-[#6E7C45]',
                                    'to-[#5E6A3A]', 'hover:from-[#5E6A3A]', 'hover:to-[#4E5A2A]'
                                );
                            } else {
                                btnSavePassword.disabled = true;
                                btnSavePassword.classList.add('disabled:bg-gray-400');
                                btnSavePassword.classList.remove('bg-gradient-to-r',
                                    'from-[#6E7C45]', 'to-[#5E6A3A]', 'hover:from-[#5E6A3A]',
                                    'hover:to-[#4E5A2A]');
                            }
                        }
                    });
...
<?php echo $__env->make('layout_superAdmin.super_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/super_admin/profile/edit.blade.php ENDPATH**/ ?>