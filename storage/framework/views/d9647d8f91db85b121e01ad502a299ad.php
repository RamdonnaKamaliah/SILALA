...
<button id="loveBtn"
  ...
  <div class="grid grid-cols-1 md:grid-cols-2 gap-8 pt-8 max-w-4xl mx-auto">
    ...
    <!-- Detail Buku -->
    <div class="grid grid-cols-2 gap-y-3 text-sm text-[#626F47]">
      <div><p class="font-semibold text-[#2E2E2E]">Penerbit</p><p><?php echo e($buku->penulis); ?></p></div>
      <div><p class="font-semibold text-[#2E2E2E]">Tahun Terbit</p><p><?php echo e($buku->tahun_terbit); ?></p></div>
      <div><p class="font-semibold text-[#2E2E2E]">Bahasa</p><p><?php echo e($buku->bahasa); ?></p></div>
      <div>
        <p class="font-semibold text-[#2E2E2E]">Kategori</p>
        <p>
          <?php if($buku->kategoris->isNotEmpty()): ?>
      ...
      <div><p class="font-semibold text-[#2E2E2E]">Jumlah Halaman</p><p><?php echo e($buku->jumlah_halaman); ?></p></div>
