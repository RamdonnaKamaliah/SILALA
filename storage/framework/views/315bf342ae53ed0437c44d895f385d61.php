                    ...
                    <tbody class="divide-y divide-gray-200" id="tableBody">
                        <?php $__currentLoopData = $data_peminjam; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $peminjam): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr class="hover:bg-gray-50 transition-colors duration-150"
                                data-status="<?php echo e($peminjam->status); ?>">
                                <!-- No -->
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-3">
                                        ...
                                        <div>
                                            <div class="font-semibold text-gray-900"><?php echo e($peminjam->user->name ?? '-'); ?>
                                ...
                                <td class="px-6 py-4">
                                    <div class="max-w-xs">
                                        <div class="font-semibold text-gray-900 truncate">
                                            <?php echo e($peminjam->buku->judul_buku ?? '-'); ?></div>
                                ...
                                <td class="px-6 py-4">
                                    <div class="space-y-1">
                                        ...
                                        <div
                                            class="flex items-center gap-2 text-sm <?php echo e($isLate ? 'text-red-600 font-semibold' : 'text-gray-600'); ?>">
                                        ...
                                        <?php if($peminjam->waktu_pengembalian_aktual): ?>
                                            <div class="flex items-center gap-2 text-sm text-gray-500">
                                                ...
                                                Dikembalikan:
                                                <?php echo e(\Carbon\Carbon::parse($peminjam->waktu_pengembalian_aktual)->translatedFormat('d M Y')); ?>
                                ...
                                <td class="px-6 py-4">
                                    <?php if($peminjam->status == 'dipinjam'): ?>
                                        <span
                                            class="inline-flex items-center px-3 py-1.5 rounded-full text-xs font-semibold <?php echo e($isLate ? 'bg-red-100 text-red-800 border border-red-200' : 'bg-blue-100 text-blue-800 border border-blue-200'); ?>">
                                            <i
                                                class="fas <?php echo e($isLate ? 'fa-exclamation-triangle' : 'fa-book'); ?> mr-1.5"></i>
                                ...
                                <td class="px-6 py-4">
                                    <?php if($hasPhoto): ?>
                                        <button type="button"
                                            onclick="lihatFoto('<?php echo e(asset('storage/' . $peminjam->foto_bukti_pengembalian)); ?>', '<?php echo e($peminjam->buku->judul_buku); ?>')"
                                ...
                                <td class="px-6 py-4">
                                    <div class="flex items-center gap-2">
                                        <?php if($peminjam->status == 'dipinjam'): ?>
                                            <!-- Konfirmasi Kembali -->
                                            <form action="<?php echo e(route('admin.data_peminjam.kembalikan', $peminjam->id)); ?>"
                                        ...
                                        <?php elseif($peminjam->status == 'menunggu_konfirmasi'): ?>
                                            <?php if($showTeguranButton): ?>
                                                <!-- Tombol Teguran -->
                                                <button type="button"
                                                    onclick="showTeguranModal(<?php echo e($peminjam->id); ?>, '<?php echo e(addslashes($peminjam->user->name)); ?>')"
                                            ...
                                            <form action="<?php echo e(route('admin.data_peminjam.konfirmasi', $peminjam->id)); ?>"
                                                method="POST" class="inline">
                                                <?php echo csrf_field(); ?>
                                                <?php echo method_field('PUT'); ?>
                                                <button type="submit"
                                        ...
                                        <?php elseif($peminjam->status == 'dikembalikan'): ?>
                                            ...
                                            <?php if($peminjam->keterangan && str_contains($peminjam->keterangan, 'Teguran:')): ?>
                                                <form
                                                    action="<?php echo e(route('admin.data_peminjam.batalkan-teguran', $peminjam->id)); ?>"
                                                    method="POST" class="inline">
                                                    <?php echo csrf_field(); ?>
                                        ...
                                        <!-- Tombol Detail -->
                                        <a href="<?php echo e(route('superadmin.data_peminjam.show', $peminjam->id)); ?>"
                    ...
                    <div class="bg-white rounded-xl border border-gray-200 p-4 shadow-sm hover:shadow-md transition-all duration-200"
                        ...
                        <div class="flex items-start justify-between mb-3">
                            ...
                            <div class="text-right">
                                <?php if($peminjam->status == 'dipinjam'): ?>
                                    <span
                                        class="inline-flex items-center px-2.5 py-1 rounded-full text-xs font-semibold <?php echo e($isLate ? 'bg-red-100 text-red-800' : 'bg-blue-100 text-blue-800'); ?>">
                        ...
                        <!-- Book Info -->
                        <div class="mb-3">
                            <h4 class="font-semibold text-gray-900 text-sm mb-1"><?php echo e($peminjam->buku->judul_buku ?? '-'); ?>
                        ...
                        <div class="mb-4 space-y-2">
                            ...
                            <div class="flex justify-between">
                                ...
                                <p
                                    class="text-sm font-medium <?php echo e($isLate && $peminjam->status == 'dipinjam' ? 'text-red-600' : 'text-gray-900'); ?>">
                                    <?php echo e(\Carbon\Carbon::parse($peminjam->tanggal_kembali)->translatedFormat('d M Y')); ?>
                        ...
                        <div class="flex flex-wrap gap-2 pt-3 border-t border-gray-200">
                            ...
                            <?php elseif($peminjam->status == 'dikembalikan'): ?>
                                ...
                                <?php if($peminjam->keterangan && str_contains($peminjam->keterangan, 'Teguran:')): ?>
                                    <form action="<?php echo e(route('admin.data_peminjam.batalkan-teguran', $peminjam->id)); ?>"
                                        method="POST" class="flex-1 min-w-[120px]">
                                        <?php echo csrf_field(); ?>
                                        <?php echo method_field('DELETE'); ?>
                                        <button type="submit"
...
<?php echo $__env->make('layout_superAdmin.super_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/super_admin/data_peminjam/index.blade.php ENDPATH**/ ?>