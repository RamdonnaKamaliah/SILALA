    ...
    <div class="book-card bg-white rounded-xl shadow-md border border-white overflow-hidden p-3 flex gap-3 
     ...
     alt="<?php echo e($fav->buku->judul_buku); ?>">
      <div class="flex flex-col justify-between flex-grow">
        <div>
          <p class="book-title text-gray-800 text-sm font-semibold leading-tight"><?php echo e($fav->buku->judul_buku); ?></p>
          <p class="text-green text-xs font-semibold mt-1"><?php echo e($fav->buku->penulis); ?></p>
        </div>
        ...
        <div class="flex items-center justify-between">
          <button
            ...
            data-title="<?php echo e($fav->buku->judul_buku); ?>"
