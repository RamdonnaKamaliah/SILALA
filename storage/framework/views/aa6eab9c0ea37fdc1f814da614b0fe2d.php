                        ...
                        <div class="flex items-center space-x-6">
                            <label class="flex items-center text-sm text-gray-800">
                                <input type="radio" name="gender" value="Perempuan" 
                                  <?php echo e((old('gender', Auth::user()->gender) == 'P' || old('gender') == 'Perempuan') ? 'checked' : ''); ?> class="accent-primary mr-2" /> Perempuan
                            </label>
                            <label class="flex items-center text-sm text-gray-800">
                                <input type="radio" name="gender" value="Laki-laki" 
                                  <?php echo e((old('gender', Auth::user()->gender) == 'L' || old('gender') == 'Laki-laki') ? 'checked' : ''); ?> class="accent-primary mr-2" /> Laki-laki  
                            </label>
                        </div>
