...
<body class="min-h-screen flex items-center justify-center px-4 relative z-10">
    ...
    <!-- Container -->
    <div
        class="w-full max-w-5xl grid md:grid-cols-2 bg-white/90 rounded-xl overflow-hidden border border-green-100 backdrop-blur-sm relative z-20">
...
unset($__errorArgs, $__bag); ?>
                ...
                <div class="flex items-center justify-between">
                    <a href="<?php echo e(route('password.request')); ?>" class="text-xs text-green-700 hover:underline">Lupa
                        Password?</a>
                    <button type="submit"
                ...
                <div class="mt-4 text-center">
                    <p class="text-base text-gray-600 mb-2">
                        Belum punya akun?
                        <a href="<?php echo e(route('register')); ?>" class="font-medium text-green-700 hover:underline">Daftar di
                            sini</a>
                    </p>
