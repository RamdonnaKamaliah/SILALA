...
@section('pageTitle', 'CMS - Pengaturan Logo & Gambar')
                ...
                @foreach ($logos as $setting)
                    <div
                        ...
                        <div class="flex items-center mb-4 pb-3 border-b border-gray-100">
                            ...
                            <h3 class="font-semibold text-gray-800">{{ $setting->label }}</h3>
                        </div>

                        {{-- Form Upload --}}
                        <form action="{{ route('admin.cms.upload') }}" method="POST" enctype="multipart/form-data"
                            class="upload-form" data-key="{{ $setting->key }}">
                            @csrf
