...
<nav id="navbar"
  ...
  class="absolute -top-2 -right-2 bg-red-500 text-white text-xs rounded-full w-5 h-5 flex items-center justify-center
         <?php echo e($showBadge ?? false ? '' : 'hidden'); ?>">
  0
</span>
      ...
      <div id="notifBox"
        ...
        <div class="text-center py-3 border-t border-gray-100">
          <a href="<?php echo e(route('user.riwayatbuku')); ?>" class="text-green text-sm font-medium hover:text-primary">
...
</nav><?php /**PATH C:\laragon\www\silala_bpmsph\resources\views\components\navbarUser.blade.php ENDPATH**/ ?>