...
<head>
    ...
    <title>Super Admin Silala | Sistem Informasi Layanan Literasi & Arsip</title>
    <link rel="icon" type="image/svg+xml" href="<?php echo e(asset('default/icon_silala.svg')); ?>">

    <?php echo $__env->make('layout_superAdmin.partial_superAdmin.link', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<body class="overflow-x-hidden bg-gray-50 min-h-screen">
    ...
    <?php echo $__env->make('layout_superAdmin.partial_superAdmin.header', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
</html><?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/layout_superAdmin/super_admin.blade.php ENDPATH**/ ?>