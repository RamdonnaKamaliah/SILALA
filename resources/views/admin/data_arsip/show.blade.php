...
<div class="p-4 md:p-6 font-poppins">
        ...
        <div class="xl:col-span-1 space-y-6">
            ...
            <div class="bg-white rounded-xl shadow-lg border border-gray-200 p-6">
                ...
                <div class="space-y-4">
                    @if ($buku->file_buku)
                        <!-- Download PDF Button -->
                        <a href="{{ asset($buku->file_buku) }}" download
    ...
    <div class="mt-6 pt-6 border-t border-gray-200">
        <div class="flex flex-col sm:flex-row justify-center gap-4">
            ...
            <form action="{{ route('admin.data_buku.restore', ['id' => $buku->id]) }}" method="POST" class="flex-1 max-w-xs">
                @csrf
                @method('PUT')
                <button type="submit"
            ...
            <form action="{{ route('admin.data_arsip.destroy', $buku->id) }}" method="POST" class="flex-1 max-w-xs">
                @csrf
                @method('DELETE')
                <button type="submit"
                    class="w-full flex items-center justify-center space-x-3 px-8 py-3
