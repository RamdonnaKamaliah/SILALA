            ...
            <div class="flex justify-between items-center navbar-height">
                ...
                <div class="flex items-center navbar-icon-spacing space-x-1 sm:space-x-2 flex-shrink-0 ml-2">
                    ...
                    <div class="relative dropdown-container">
                        <button class="p-2 rounded-full text-primary_pale hover:text-white hover:bg-primary_light/30 focus:outline-none focus:ring-2 focus:ring-white/50 relative transition-all duration-200 touch-target icon-button" id="notification-button">
                            <i class="fas fa-bell text-base sm:text-lg"></i>
                            <span class="notification-badge">3</span>
                        </button>
                        
                        <div class="dropdown-menu popup-shadow border border-primary_pale/50 glass-effect" id="notification-popup">
                            <div class="p-4 border-b border-primary_pale/30 bg-gradient-to-r from-primary_pale to-white rounded-t-xl">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-base sm:text-lg font-bold text-primary-text flex items-center">
                                        <i class="fas fa-bell mr-2 text-primary_medium"></i>
                                        Notifikasi
                                    </h3>
                                    <span class="text-xs text-primary_medium cursor-pointer hover:underline font-medium flex items-center">
                            ...
                            <div class="dropdown-content overflow-y-auto custom-scrollbar">
                                <div class="notification-item p-3 sm:p-4 border-b border-primary_pale/30 hover:bg-primary_pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        ...
                                        <div class="ml-3 flex-1 min-w-0">
                                            <div class="flex justify-between items-start gap-2">
                                                ...
                                                <span class="text-xs text-primary_medium bg-primary_pale/50 px-2 py-1 rounded-full font-medium whitespace-nowrap">Baru</span>
                                            </div>
                                ...
                                <div class="notification-item p-3 sm:p-4 hover:bg-primary_pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 mt-1">
                            ...
                            <div class="p-3 border-t border-primary_pale/30 bg-white rounded-b-xl">
                                <a href="#" class="flex items-center justify-center text-sm font-semibold text-primary_medium hover:text-primary_dark transition-colors duration-200 py-2 rounded-lg hover:bg-primary_pale/50">
                    ...
                    <!-- Pesan -->
                    <div class="relative dropdown-container">
                        <button class="p-2 rounded-full text-primary_pale hover:text-white hover:bg-primary_light/30 focus:outline-none focus:ring-2 focus:ring-white/50 relative transition-all duration-200 touch-target icon-button" id="message-button">
                            <i class="fas fa-envelope text-base sm:text-lg"></i>
                            <span class="message-badge">5</span>
                        </button>
                        
                        <div class="dropdown-menu popup-shadow border border-primary_pale/50 glass-effect" id="message-popup">
                            <div class="p-4 border-b border-primary_pale/30 bg-gradient-to-r from-primary_pale to-white rounded-t-xl">
                                <div class="flex justify-between items-center">
                                    <h3 class="text-base sm:text-lg font-bold text-primary-text flex items-center">
                                        <i class="fas fa-envelope mr-2 text-primary_medium"></i>
                                        Pesan
                                    </h3>
                                    <span class="text-xs text-primary_medium cursor-pointer hover:underline font-medium flex items-center">
                                        <i class="fas fa-check-double mr-1"></i>
                            ...
                            <div class="dropdown-content overflow-y-auto custom-scrollbar">
                                <div class="message-item p-3 sm:p-4 border-b border-primary_pale/30 hover:bg-primary_pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 mt-1">
                                ...
                                <div class="message-item p-3 sm:p-4 hover:bg-primary_pale/50 cursor-pointer transition-all duration-200 group">
                                    <div class="flex items-start">
                                        <div class="flex-shrink-0 mt-1">
                    ...
                    <div class="relative dropdown-container">
                        ...
                        <!-- BUTTON PROFIL -->
                        <button class="flex items-center text-sm rounded-xl focus:outline-none focus:ring-2 focus:ring-white/50 hover:bg-primary_light/30 px-2 sm:px-3 py-2 transition-all duration-200 group touch-target"
                                id="user-menu-button">
                            ...
                            <div class="ml-2 sm:ml-3 text-left hidden lg:block">
                                ...
                                <p class="text-primary_pale/80 text-xs truncate"><?php echo e($admin->role ?? 'Administrator'); ?></p>
                            </div>

                            <!-- ICON CHEVRON -->
                            <i class="fas fa-chevron-down ml-2 text-primary_pale/80 text-xs hidden lg:block transition-transform duration-200"
                            id="chevron-icon"></i>

                        </button>

                        <!-- DROPDOWN MENU -->
                        <div class="dropdown-menu shadow-2xl border border-primary_pale/30 glass-effect" id="dropdown-menu">

                            <!-- HEADER DROPDOWN -->
                            <div class="p-4 sm:p-6 bg-gradient-to-br from-primary_dark to-primary_medium rounded-t-2xl text-white">
                            ...
                            <div class="p-3 sm:p-4 space-y-2">
                                ...
                                class="profile-item flex items-center justify-between px-3 sm:px-4 py-2.5 sm:py-3 text-sm text-gray-700 hover:bg-primary_pale/50 hover:text-primary_dark rounded-xl transition-all duration-200 group">

                                    <div class="flex items-center min-w-0 flex-1">
                                        <div class="w-8 h-8 flex items-center justify-center mr-3 bg-primary_pale rounded-lg group-hover:bg-primary_medium group-hover:text-white transition-all duration-200 flex-shrink-0">
                                            <i class="fas fa-user text-primary_medium group-hover:text-white text-sm"></i>
                                        </div>
                                    ...
                                    <i class="fas fa-chevron-right text-gray-400 group-hover:text-primary_dark text-xs ml-2 flex-shrink-0"></i>
                                </a>

                            </div>

                            <div class="border-t border-primary_pale/30 mx-4"></div>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\laragon\www\silala_bpmsph\resources\views\components\navbarAdmin.blade.php ENDPATH**/ ?>