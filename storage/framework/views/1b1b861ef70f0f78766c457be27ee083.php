                    ...
                    <div class="relative" id="adminDropdown">
                        ...
                        <button id="avatarBtn" class="flex items-center gap-2 focus:outline-none">
                            ...
                            <div class="text-left hidden sm:block">
                                ...
                                <p class="text-xs text-white/80">super_admin</p>
                            </div>
                        </button>
                        ...
                        <div id="dropdownMenu"
                            ...
                            <!-- Menu -->
                            <a href="<?php echo e(route('superadmin.profile.index')); ?>"
...
<?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/components/navbarSuperAdmin.blade.php ENDPATH**/ ?>