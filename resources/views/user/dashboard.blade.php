...
<main
  ...
  <!-- Kartu Sambutan -->
<section class="relative bg-gradient-to-r from-[#626F47] to-[#A4B465] text-white 
...
<!-- Riwayat Anda -->
    <section class="pb-8">
      <h2 class="text-lg md:text-xl font-semibold text-[#626F47] mb-4 ml-2">Riwayat Anda</h2>
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
