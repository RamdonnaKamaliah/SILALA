...
<div class="min-h-screen bg-gray-50 p-4 md:p-6 lg:p-8">
    ...
    <div class="mb-8">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <!-- Back Button -->
            <a href="<?php echo e(route('superadmin.data_peminjam.index')); ?>" 
...
<?php echo $__env->make('layout_superAdmin.super_admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\laragon\www\SILALA_BPMSPH\resources\views/super_admin/data_peminjam/show.blade.php ENDPATH**/ ?>